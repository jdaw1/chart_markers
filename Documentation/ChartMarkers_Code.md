...
So the markers&rsquo; SVG files are concise, ranging from 156 bytes (<span class="markerID">JPY</span>), to a median of 262 bytes, to a maximum of 638 bytes (<span class="markerID">GEL</span>). 
Of the 141 markers, only six &asymp;&#8239;4.3% exceed 500 bytes: these are included in the nearby table.
