...
| USD | ![USD](../ChartMarkers/USD.svg) | <a name="USD">![USD](../ChartMarkers_enlarged/USD_enlarged.svg)</a> | <p>Star from [flag](http://en.wikipedia.org/wiki/Flag_of_the_United_States); thick black edge so that most important currency has maximum contrast. Slightly larger than other markers: it is the most important currency.</p><p>&exist;&nbsp;[comment re centre](ChartMarkers_Code.md#centres).</p> | ![USD](../ChartLines/USD_line.svg)<br/>000000 |
