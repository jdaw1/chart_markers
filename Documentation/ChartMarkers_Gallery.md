...
| DE | ![DE](../ChartMarkers/DE.svg) | <a name="DE">![DE](../ChartMarkers_enlarged/DE_enlarged.svg)</a> | <p>Simplified from six to four columns, the [Brandenburg Gate](http://en.wikipedia.org/wiki/Brandenburg_Gate), in Berlin, Germany.</p><p>Germany has an alternate marker, <nobr>![DE_2](../ChartMarkers/DE_2.svg)&nbsp;=&nbsp;<span class="markerID">DE_2</span>,</nobr> which can be used for the (now former) East Germany, or for other purposes.</p> | ![DE](../ChartLines/DE_line.svg)<br/>000000<br/>FFFFFF |
