...
| [<span class="markerID">PT</span>](#PT) | ![PT](../ChartMarkers/PT.svg) | <a name="PT">![PT](../ChartMarkers_enlarged/PT_enlarged.svg)</a> | <p>[National Cockade of Portugal](http://en.wikipedia.org/wiki/National_symbols_of_Portugal#Vexillology), simplified.</p><p>Portugal has an alternate marker, <nobr>![PT_2](../ChartMarkers/PT_2.svg)&nbsp;=&nbsp;<span class="markerID">PT_2</span>,</nobr> which can be used for green bonds, or for other purposes.</p> | ![PT](../ChartLines/PT_line.svg)<br/>DA291C<br/>046A38 |
