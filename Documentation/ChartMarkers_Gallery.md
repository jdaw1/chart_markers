...
| SN | ![SN](../ChartMarkers/SN.svg) | <a name="SN">![SN](../ChartMarkers_enlarged/SN_enlarged.svg)</a> | \[Mentioned in [issue&nbsp;7, &ldquo;Line colouration collisions&rdquo;](http://github.com/jdaw1/chart_markers/issues/7).\]<br/>From the [flag of Senegal](http://en.wikipedia.org/wiki/Flag_of_Senegal). | ![SN](../ChartLines/SN_line.svg)<br/>1D6233<br/>FDEF42 |
