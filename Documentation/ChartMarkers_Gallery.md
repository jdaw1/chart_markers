...
| \_EIB | ![\_EIB](../ChartMarkers/_EIB.svg) | <a name="_EIB">![_EIB](../ChartMarkers_enlarged/_EIB_enlarged.svg)</a> | The [logo of the European Investment Bank](https://www.eib.org/en/stories/eib-new-logo) includes an arch, referring to the building, which seems to be about a third of a 5&ratio;4 ellipse. The marker is the whole ellipse, with horizonal lines to further echo the logo, in logo colours. (Discussion in [issue&nbsp;16](https://github.com/jdaw1/chart_markers/issues/16).) | ![\_EIB](../ChartLines/_EIB_line.svg)<br/>003399<br/>9D9D9C |
