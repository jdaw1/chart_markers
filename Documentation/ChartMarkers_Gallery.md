...
| EU | ![EU](../ChartMarkers/EU.svg) | <a name="EU">![EU](../ChartMarkers_enlarged/EU_enlarged.svg)</a> | As for <span class="markerID">[EUR](#EUR)</span>&nbsp;=&nbsp;&euro;, except the horizontal line replaced by a star from the [flag of Europe](http://en.wikipedia.org/wiki/Flag_of_Europe), which is used as the flag of the European Union. (Discussion about variant markers in [issue&nbsp;17](https://github.com/jdaw1/chart_markers/issues/17).) | ![EU](../ChartLines/EU_line.svg)<br/>FF33FF<br/>FFFFFF |
