...
| FR | ![FR](../ChartMarkers/FR.svg) | <a name="FR">![FR](../ChartMarkers_enlarged/FR_enlarged.svg)</a> | <p>[Hexagonal shape of France](http://en.wikipedia.org/wiki/Outline_of_France); in blue-white-red of [flag](http://en.wikipedia.org/wiki/Flag_of_France).</p><p>France has an alternate marker, <nobr>![FR_2](../ChartMarkers/FR_2.svg)&nbsp;=&nbsp;<span class="markerID">FR_2</span>.</nobr> The original purpose is narrowly related to its national debt: ![FR](../ChartMarkers/FR.svg) for OAT&euro;i linked to European inflation (e.g. [0.1% July&nbsp;2053](http://www.aft.gouv.fr/en/titre/fr0014008181)); but ![FR_2](../ChartMarkers/FR_2.svg) for OATi linked to French inflation (e.g. [0.55% Mar&nbsp;2039](http://www.aft.gouv.fr/en/titre/fr001400ikw5)). Of course, the alternate marker can be used for other purposes.</p> | ![FR](../ChartLines/FR_line.svg)<br/>0055A4<br/>EF4135 |
| IT | ![IT](../ChartMarkers/IT.svg) | <a name="IT">![IT](../ChartMarkers_enlarged/IT_enlarged.svg)</a> | <p>Rome&rsquo;s [Colosseum](http://en.wikipedia.org/wiki/Colosseum), in the colours of the [flag of Italy](http://en.wikipedia.org/wiki/Flag_of_Italy).<p><p>Italy has an alternate marker, <nobr>![IT_2](../ChartMarkers/IT_2.svg)&nbsp;=&nbsp;<span class="markerID">IT_2</span>,</nobr> which can be used for southern Italy when that is being distinguished, or for other purposes.</p> | ![IT](../ChartLines/IT_line.svg)<br/>008C45<br/>CD212A |
...
| PT | ![PT](../ChartMarkers/PT.svg) | <a name="PT">![PT](../ChartMarkers_enlarged/PT_enlarged.svg)</a> | [National Cockade of Portugal](http://en.wikipedia.org/wiki/National_symbols_of_Portugal#Vexillology), simplified. | ![PT](../ChartLines/PT_line.svg)<br/>DA291C<br/>046A38 |
...
| SK | ![SK](../ChartMarkers/SK.svg) | <a name="SK">![SK](../ChartMarkers_enlarged/SK_enlarged.svg)</a> | Cross from the [flag of Slovakia](http://en.wikipedia.org/wiki/Flag_of_Slovakia), symmetrified and simplified. | ![SK](../ChartLines/SK_line.svg)<br/>EF3340<br/>034DA3 |
...
| ME | ![ME](../ChartMarkers/ME.svg) | <a name="ME">![ME](../ChartMarkers_enlarged/ME_enlarged.svg)</a> | <p>*Globus crucifer azure crossed Or*, from the [coat of arms of Montenegro](http://en.wikipedia.org/wiki/Coat_of_arms_of_Montenegro#/media/File:Coat_of_arms_of_Montenegro.svg).</p><p><a href="https://github.com/jdaw1/chart_markers/issues/12">Issue 12</a> asks whether to &ldquo;Rotate <span class="markerID">ME</span> = Montenegro by 11&deg;?&rdquo;</p> | ![ME](../ChartLines/ME_line.svg)<br/>215F8F<br/>D3AE45 |
