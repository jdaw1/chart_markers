...
Please do suggest possible improvements in an [issue](http://github.com/jdaw1/chart_markers/issues/), and do so before this deadline.

For [issues](http://github.com/jdaw1/chart_markers/issues/) raised after Friday 31st March 2023 the standard toughens: &ldquo;*the proposed new must be better than the old, and better by a margin large enough to justify that there be any change at all*&rdquo;. 
That is, post draft, there will be a reluctance to make changes.

It is intended that [issues](http://github.com/jdaw1/chart_markers/issues/) raised by Friday 31st March 2023 will be processed (rejected, or accepted and implemented) by the end of the Easter weekend, so by Monday 10th April 2023 (intended, not quite promised). 
...
| CAD | ![CAD](../ChartMarkers/CAD.svg) | <a name="CAD">![CAD](../ChartMarkers_enlarged/CAD_enlarged.svg)</a> | Three-lobed [Canada maple leaf](http://commons.wikimedia.org/wiki/File:Flag_of_Canada_(construction_sheet_-_leaf_geometry).svg), vigorously symmetrified, in the red and white [national colours of Canada](http://en.wikipedia.org/wiki/National_colours_of_Canada). The line colours are red and black, taken from the colours of the [Canadian National Men&rsquo;s Hockey Team](http://en.wikipedia.org/wiki/Canada_men's_national_ice_hockey_team). | ![CAD](../ChartLines/CAD_line.svg)<br/>FF0000<br/>000000 |
| AUD | ![AUD](../ChartMarkers/AUD.svg) | <a name="AUD">![AUD](../ChartMarkers_enlarged/AUD_enlarged.svg)</a> | A seven pointed star with inner radius =&nbsp;4/9, from the Australian [flag](http://en.wikipedia.org/wiki/Flag_of_Australia#Construction), in the green and gold [national colours of Australia](http://en.wikipedia.org/wiki/National_colours_of_Australia). | ![AUD](../ChartLines/AUD_line.svg)<br/>00843D<br/>FFCD00 |
| NZD | ![NZD](../ChartMarkers/NZD.svg) | <a name="NZD">![NZD](../ChartMarkers_enlarged/NZD_enlarged.svg)</a> | Five-pointed star from the [flag of New Zealand](http://en.wikipedia.org/wiki/Flag_of_New_Zealand#Specifications). | ![NZD](../ChartLines/NZD_line.svg)<br/>012169<br/>C8102E |
| SEK | ![SEK](../ChartMarkers/SEK.svg) | <a name="SEK">![SEK](../ChartMarkers_enlarged/SEK_enlarged.svg)</a> | From the [flag of Sweden](http://en.wikipedia.org/wiki/Flag_of_Sweden). | ![SEK](../ChartLines/SEK_line.svg)<br/>004B87<br/>FFD100 |
| NOK | ![NOK](../ChartMarkers/NOK.svg) | <a name="NOK">![NOK](../ChartMarkers_enlarged/NOK_enlarged.svg)</a> | From the [flag of Norway](http://en.wikipedia.org/wiki/Flag_of_Norway). | ![NOK](../ChartLines/NOK_line.svg)<br/>BA0C2F<br/>00205B |
...
| HKD | ![HKD](../ChartMarkers/HKD.svg) | <a name="HKD">![HKD](../ChartMarkers_enlarged/HKD_enlarged.svg)</a> | The five-leaf pattern of the [flag of Hong Kong](http://en.wikipedia.org/wiki/Flag_of_Hong_Kong), simplified to a pentagon, double-edged like the logo of the [HKMA](http://www.hkma.gov.hk/eng/) = Hong Kong Monetary Authority. | ![HKD](../ChartLines/HKD_line.svg)<br/>FF0000 |
| TWD | ![TWD](../ChartMarkers/TWD.svg) | <a name="TWD">![TWD](../ChartMarkers_enlarged/TWD_enlarged.svg)</a> | From the [flag of Taiwan = Republic of China](http://en.wikipedia.org/wiki/Flag_of_the_Republic_of_China). Alas a twelve-pointed star is a blur when shown as small as a chart marker. | ![TWD](../ChartLines/TWD_line.svg)<br/>0029CC<br/>FFFFFF |
| KRW | ![KRW](../ChartMarkers/KRW.svg) | <a name="KRW">![KRW](../ChartMarkers_enlarged/KRW_enlarged.svg)</a> | From the [flag of South Korea](http://en.wikipedia.org/wiki/Flag_of_South_Korea). The shape, but not the colour, has the desired rotational symmetry. | ![KRW](../ChartLines/KRW_line.svg)<br/>CD2E3A<br/>0047A0 |
| SGD | ![SGD](../ChartMarkers/SGD.svg) | <a name="SGD">![SGD](../ChartMarkers_enlarged/SGD_enlarged.svg)</a> | White star from the [flag of Singapore](http://en.wikipedia.org/wiki/Flag_of_Singapore); circle and colour from logo of [MAS](http://www.mas.gov.sg/) = Monetary Authority of Singapore. | ![SGD](../ChartLines/SGD_line.svg)<br/>A78337 |
| MYR | ![MYR](../ChartMarkers/MYR.svg) | <a name="MYR">![MYR](../ChartMarkers_enlarged/MYR_enlarged.svg)</a> | \[Mentioned in [issue&nbsp;7, &ldquo;Line colouration collisions&rdquo;](http://github.com/jdaw1/chart_markers/issues/7).\]<br/>Star from the [flag of Malaysia](http://web.archive.org/web/20120318034534/http://pmr.penerangan.gov.my/index.php/maklumat-kenegaraan/194-bendera-malaysia.html), simplified from 14 outer points to 14 vertices (i.e., 7 outer points). The square has rotational symmetry of order 4, the star of order 7, with the same centres, but the whole does not have rotational symmetry. | ![MYR](../ChartLines/MYR_line.svg)<br/>00326A<br/>DECE05 |
...
| PHP | ![PHP](../ChartMarkers/PHP.svg) | <a name="PHP">![PHP](../ChartMarkers_enlarged/PHP_enlarged.svg)</a> | \[Mentioned in [issue&nbsp;7, &ldquo;Line colouration collisions&rdquo;](http://github.com/jdaw1/chart_markers/issues/7).\]<br/>Big star from the [flag of the Philippines](http://en.wikipedia.org/wiki/Flag_of_the_Philippines#Construction), simplified, in flag gold and blue. | ![PHP](../ChartLines/PHP_line.svg)<br/>0038A8<br/>FCD116 |
...
| PKR | ![PKR](../ChartMarkers/PKR.svg) | <a name="PKR">![PKR](../ChartMarkers_enlarged/PKR_enlarged.svg)</a> | <p>\[Mentioned in [issue&nbsp;7, &ldquo;Line colouration collisions&rdquo;](http://github.com/jdaw1/chart_markers/issues/7).\]<br/>From the [flag of Pakistan](http://en.wikipedia.org/wiki/Flag_of_Pakistan), five-pointed star rotated by ArcTan[9/8] &asymp;&nbsp;48.366&deg;.</p><p>To confirm that the rotation is correct just before final closing tag insert &ldquo;`<g stroke-width='0.2' stroke='black' opacity='25%' fill='none'><path d='M 11.25 -10 L -11.25 10'/><circle r='0.4'/></g>`&rdquo;. &exist;&nbsp;[comment re centre](ChartMarkers_Code.md#centres).</p> | ![PKR](../ChartLines/PKR_line.svg)<br/>01411C<br/>FFFFFF |
...
| ISK | ![ISK](../ChartMarkers/ISK.svg) | <a name="ISK">![ISK](../ChartMarkers_enlarged/ISK_enlarged.svg)</a> | \[Mentioned in [issue&nbsp;7, &ldquo;Line colouration collisions&rdquo;](http://github.com/jdaw1/chart_markers/issues/7).\]<br/>From the [flag of Iceland](http://en.wikipedia.org/wiki/Flag_of_Iceland). | ![ISK](../ChartLines/ISK_line.svg)<br/>02529C<br/>DC1E35 |
...
| CZK | ![CZK](../ChartMarkers/CZK.svg) | <a name="CZK">![CZK](../ChartMarkers_enlarged/CZK_enlarged.svg)</a> | \[Mentioned in [issue&nbsp;7, &ldquo;Line colouration collisions&rdquo;](http://github.com/jdaw1/chart_markers/issues/7).\]<br/>Triangle from the hoist of the [Czech flag](http://en.wikipedia.org/wiki/Flag_of_the_Czech_Republic), duplicated, back to back, in flag colours. | ![CZK](../ChartLines/CZK_line.svg)<br/>D7141A<br/>11457E |
| HUF | ![HUF](../ChartMarkers/HUF.svg) | <a name="HUF">![HUF](../ChartMarkers_enlarged/HUF_enlarged.svg)</a> | Cross from [Hungarian coat of arms](http://en.wikipedia.org/wiki/National_symbols_of_Hungary#Flags_and_heraldry), symmetrified and simplified, in [flag](http://en.wikipedia.org/wiki/Flag_of_Hungary) green and red. | ![HUF](../ChartLines/HUF_line.svg)<br/>00843D<br/>CE2939 |
| RON | ![RON](../ChartMarkers/RON.svg) | <a name="RON">![RON](../ChartMarkers_enlarged/RON_enlarged.svg)</a> | [Palace of Parliament](http://goo.gl/maps/RQzKYRL8b2pud8Bk8), Bucharest, in [Romanian-flag](http://en.wikipedia.org/wiki/Flag_of_Romania) blue-yellow-red. | ![RON](../ChartLines/RON_line.svg)<br/>002B7F<br/>FCD116 |
| BGN | ![BGN](../ChartMarkers/BGN.svg) | <a name="BGN">![BGN](../ChartMarkers_enlarged/BGN_enlarged.svg)</a> | [Cathedral Saint Aleksandar Nevski](http://goo.gl/maps/31A83q7KSnGaavy59), in [Bulgarian-flag](http://en.wikipedia.org/wiki/Flag_of_Bulgaria) green. | ![BGN](../ChartLines/BGN_line.svg)<br/>00AF66<br/>FFFFFF |
...
| RSD | ![RSD](../ChartMarkers/RSD.svg) | <a name="RSD">![RSD](../ChartMarkers_enlarged/RSD_enlarged.svg)</a> | [Temple of Saint Sava](http://goo.gl/maps/iPTF3w1RwiyL1Ecc8), Belgrade, in [Serbian-flag](http://en.wikipedia.org/wiki/Flag_of_Serbia) blue and red. | ![RSD](../ChartLines/RSD_line.svg)<br/>C7363D<br/>0C4077 |
| ALL | ![ALL](../ChartMarkers/ALL.svg) | <a name="ALL">![ALL](../ChartMarkers_enlarged/ALL_enlarged.svg)</a> | Eagle on [flag of Albania](http://en.wikipedia.org/wiki/Flag_of_Albania#/media/File:Flag_of_Albania.svg): circle from claws, diamond from tail. | ![ALL](../ChartLines/ALL_line.svg)<br/>000000<br/>DA291C |
| MKD | ![MKD](../ChartMarkers/MKD.svg) | <a name="MKD">![MKD](../ChartMarkers_enlarged/MKD_enlarged.svg)</a> | From the [flag of North Macedonia](http://en.wikipedia.org/wiki/Flag_of_North_Macedonia#/media/File:Construction_sheet_of_the_flag_of_North_Macedonia.svg). | ![MKD](../ChartLines/MKD_line.svg)<br/>CE2028<br/>F9D616 |
...
| TRY | ![TRY](../ChartMarkers/TRY.svg) | <a name="TRY">![TRY](../ChartMarkers_enlarged/TRY_enlarged.svg)</a> | From the [flag of T&uuml;rkiye](http://en.wikipedia.org/wiki/Flag_of_Turkey#Dimensions), in English [formerly known as &lsquo;Turkey&rsquo;](http://en.wikipedia.org/wiki/Name_of_Turkey#Presidential_circular_on_use_of_T%C3%BCrkiye). | ![TRY](../ChartLines/TRY_line.svg)<br/>E30A17 |
| SAR | ![SAR](../ChartMarkers/SAR.svg) | <a name="SAR">![SAR](../ChartMarkers_enlarged/SAR_enlarged.svg)</a> | Simplified [flag of Saudi Arabia](http://en.wikipedia.org/wiki/Flag_of_Saudi_Arabia). | ![SAR](../ChartLines/SAR_line.svg)<br/>009639<br/>FFFFFF |
...
| KWD | ![KWD](../ChartMarkers/KWD.svg) | <a name="KWD">![KWD](../ChartMarkers_enlarged/KWD_enlarged.svg)</a> | Black isosceles trapezium in hoist of [flag of Kuwait](http://en.wikipedia.org/wiki/Flag_of_Kuwait), duplicated for symmetry, in flag colours. | ![KWD](../ChartLines/KWD_line.svg)<br/>000000<br/>CE1126 |
...
| DZD | ![DZD](../ChartMarkers/DZD.svg) | <a name="DZD">![DZD](../ChartMarkers_enlarged/DZD_enlarged.svg)</a> | \[Mentioned in [issue&nbsp;7, &ldquo;Line colouration collisions&rdquo;](http://github.com/jdaw1/chart_markers/issues/7).\]<br/>All the points of the red star touch the boundary of the green (four inside, one outside), a property of two of the points of the star in the [flag of Algeria](http://en.wikipedia.org/wiki/Flag_of_Algeria) = Dzair. The rectangles have rotational symmetry of order 2, the star of order 5, all with the [same centres](ChartMarkers_Code.md#centres), but the whole does not have rotational symmetry. | ![DZD](../ChartLines/DZD_line.svg)<br/>006633<br/>FFFFFF |
| IRR | ![IRR](../ChartMarkers/IRR.svg) | <a name="IRR">![IRR](../ChartMarkers_enlarged/IRR_enlarged.svg)</a> | Simplified and symmetrified map of [Iran](http://en.wikipedia.org/wiki/Iran#Administrative_divisions), in [flag](http://en.wikipedia.org/wiki/Flag_of_Iran) colours. | ![IRR](../ChartLines/IRR_line.svg)<br/>239F40<br/>FFFFFF |
| IQD | ![IQD](../ChartMarkers/IQD.svg) | <a name="IQD">![IQD](../ChartMarkers_enlarged/IQD_enlarged.svg)</a> | Wings of eagle in the [coat of arms of Iraq](http://en.wikipedia.org/wiki/Coat_of_arms_of_Iraq). | ![IQD](../ChartLines/IQD_line.svg)<br/>000000<br/>E3B329 |
| ILS | ![ILS](../ChartMarkers/ILS.svg) | <a name="ILS">![ILS](../ChartMarkers_enlarged/ILS_enlarged.svg)</a> | Star of David, from the [flag of Israel](http://en.wikipedia.org/wiki/Flag_of_Israel). At the likely size of a marker the six white triangles in the six arms would not be visible, so have been omitted. | ![ILS](../ChartLines/ILS_line.svg)<br/>005EB8<br/>FFFFFF |
...
| ZAR | ![ZAR](../ChartMarkers/ZAR.svg) | <a name="ZAR">![ZAR](../ChartMarkers_enlarged/ZAR_enlarged.svg)</a> | Symmetrified [flag](http://en.wikipedia.org/wiki/Flag_of_South_Africa); orange as distinctive South African colour. | ![ZAR](../ChartLines/ZAR_line.svg)<br/>007749<br/>FFA500 |
| NGN | ![NGN](../ChartMarkers/NGN.svg) | <a name="NGN">![NGN](../ChartMarkers_enlarged/NGN_enlarged.svg)</a> | From [Nigerian flag](http://en.wikipedia.org/wiki/Flag_of_Nigeria#Design). | ![NGN](../ChartLines/NGN_line.svg)<br/>009639<br/>FFFFFF |
| ETB | ![ETB](../ChartMarkers/ETB.svg) | <a name="ETB">![ETB](../ChartMarkers_enlarged/ETB_enlarged.svg)</a> | From the 2009 [flag of Ethiopia](http://en.wikipedia.org/wiki/Flag_of_Ethiopia). | ![ETB](../ChartLines/ETB_line.svg)<br/>0F47AF<br/>FCDD09 |
| SDG | ![SDG](../ChartMarkers/SDG.svg) | <a name="SDG">![SDG](../ChartMarkers_enlarged/SDG_enlarged.svg)</a> | Inspired by the wings of the [Secretary bird](http://en.wikipedia.org/wiki/Secretary_bird) in the [emblem of Sudan](http://en.wikipedia.org/wiki/Emblem_of_Sudan). | ![SDG](../ChartLines/SDG_line.svg)<br/>000000<br/>FFFFFF |
| KYS | ![KYS](../ChartMarkers/KYS.svg) | <a name="KYS">![KYS](../ChartMarkers_enlarged/KYS_enlarged.svg)</a> | Simplified shield from the [flag of Kenya](http://en.wikipedia.org/wiki/Flag_of_Kenya). | ![KYS](../ChartLines/KYS_line.svg)<br/>BB0000<br/>000000 |
| TZS | ![TZS](../ChartMarkers/TZS.svg) | <a name="TZS">![TZS](../ChartMarkers_enlarged/TZS_enlarged.svg)</a> | From the [flag of Tanzania](http://en.wikipedia.org/wiki/Flag_of_Tanzania), simplified. | ![TZS](../ChartLines/TZS_line.svg)<br/>FCD116<br/>000000 |
| UGX | ![UGX](../ChartMarkers/UGX.svg) | <a name="UGX">![UGX](../ChartMarkers_enlarged/UGX_enlarged.svg)</a> | From the [flag of Uganda](http://en.wikipedia.org/wiki/Flag_of_Uganda). | ![UGX](../ChartLines/UGX_line.svg)<br/>000000<br/>D90000 |
| CDF | ![CDF](../ChartMarkers/CDF.svg) | <a name="CDF">![CDF](../ChartMarkers_enlarged/CDF_enlarged.svg)</a> | \[Mentioned in [issue&nbsp;7, &ldquo;Line colouration collisions&rdquo;](http://github.com/jdaw1/chart_markers/issues/7).\]<br/>From the [flag of the Democratic Republic of the Congo](http://en.wikipedia.org/wiki/Flag_of_the_Democratic_Republic_of_the_Congo). | ![CDF](../ChartLines/CDF_line.svg)<br/>007FFF<br/>F7D618 |
| GHS | ![GHS](../ChartMarkers/GHS.svg) | <a name="GHS">![GHS](../ChartMarkers_enlarged/GHS_enlarged.svg)</a> | From the [coat of arms of Ghana](http://en.wikipedia.org/wiki/Ghana#/media/File:Coat_of_arms_of_Ghana.svg). | ![GHS](../ChartLines/GHS_line.svg)<br/>000000<br/>FFD100 |
| SN | ![SN](../ChartMarkers/SN.svg) | <a name="SN">![SN](../ChartMarkers_enlarged/SN_enlarged.svg)</a> | \[Mentioned in [issue&nbsp;7, &ldquo;Line colouration collisions&rdquo;](http://github.com/jdaw1/chart_markers/issues/7).\]<br/>From the [flag of Senegal](http://en.wikipedia.org/wiki/Flag_of_Senegal). | ![SN](../ChartLines/SN_line.svg)<br/>FDEF42<br/>1D6233 |
...
| CLP | ![CLP](../ChartMarkers/CLP.svg) | <a name="CLP">![CLP](../ChartMarkers_enlarged/CLP_enlarged.svg)</a> | \[Mentioned in [issue&nbsp;7, &ldquo;Line colouration collisions&rdquo;](http://github.com/jdaw1/chart_markers/issues/7).\]<br/>From the [flag of Chile](http://en.wikipedia.org/wiki/Flag_of_Chile#Construction). The square has rotational symmetry of order 4, the star of order 5, with the same centres, but the whole does not have rotational symmetry. | ![CLP](../ChartLines/CLP_line.svg)<br/>D52B1E<br/>0033A0 |
| COP | ![COP](../ChartMarkers/COP.svg) | <a name="COP">![COP](../ChartMarkers_enlarged/COP_enlarged.svg)</a> | \[Mentioned in [issue&nbsp;7, &ldquo;Line colouration collisions&rdquo;](http://github.com/jdaw1/chart_markers/issues/7).\]<br/>Banded circle from logo of [*Banco de la Rep&uacute;blica de Colombia*](http://www.banrep.gov.co/en/); [flag](http://en.wikipedia.org/wiki/Flag_of_Colombia) colours. | ![COP](../ChartLines/COP_line.svg)<br/>003087<br/>FFCD00 |
| PEN | ![PEN](../ChartMarkers/PEN.svg) | <a name="PEN">![PEN](../ChartMarkers_enlarged/PEN_enlarged.svg)</a> | Circle for sun in [early Peruvian flag](http://en.wikipedia.org/wiki/Flag_of_Peru#Flag_of_March_1822), in modern red and white. | ![PEN](../ChartLines/PEN_line.svg)<br/>C8102E<br/>FFFFFF |
| UYU | ![UYU](../ChartMarkers/UYU.svg) | <a name="UYU">![UYU](../ChartMarkers_enlarged/UYU_enlarged.svg)</a> | \[Mentioned in [issue&nbsp;7, &ldquo;Line colouration collisions&rdquo;](http://github.com/jdaw1/chart_markers/issues/7).\]<br/>[Flag of Uruguay](http://en.wikipedia.org/wiki/Flag_of_Uruguay) has four blue stripes, two of which have ratio 17&ratio;2. | ![UYU](../ChartLines/UYU_line.svg)<br/>7B3F00<br/>FFFFFF |
| ARS | ![ARS](../ChartMarkers/ARS.svg) | <a name="ARS">![ARS](../ChartMarkers_enlarged/ARS_enlarged.svg)</a> | From the [flag of Argentina](http://en.wikipedia.org/wiki/Flag_of_Argentina). | ![ARS](../ChartLines/ARS_line.svg)<br/>6CACE4<br/>FFFFFF |
| BOB | ![BOB](../ChartMarkers/BOB.svg) | <a name="BOB">![BOB](../ChartMarkers_enlarged/BOB_enlarged.svg)</a> | \[Mentioned in [issue&nbsp;7, &ldquo;Line colouration collisions&rdquo;](http://github.com/jdaw1/chart_markers/issues/7).\]<br/>[Wiphala](http://en.wikipedia.org/wiki/Flag_of_Bolivia#/media/File:Banner_of_the_Qulla_Suyu.svg), dual flag of Bolivia, simplified from 7&times;7 to 5&times;5. | ![BOB](../ChartLines/BOB_line.svg)<br/>000000<br/>FFFFFF |
...
| EC | ![EC](../ChartMarkers/EC.svg) | <a name="EC">![EC](../ChartMarkers_enlarged/EC_enlarged.svg)</a> | \[Mentioned in [issue&nbsp;7, &ldquo;Line colouration collisions&rdquo;](http://github.com/jdaw1/chart_markers/issues/7).\]<br/>Oval from the [coat of arms of Ecuador](http://en.wikipedia.org/wiki/Flag_of_Ecuador#/media/File:Coat_of_arms_of_Ecuador.svg); in [flag](http://en.wikipedia.org/wiki/Flag_of_Ecuador) yellow-blue-red. | ![EC](../ChartLines/EC_line.svg)<br/>0072CE<br/>FFD100 |
...
| TTD | ![TTD](../ChartMarkers/TTD.svg) | <a name="TTD">![TTD](../ChartMarkers_enlarged/TTD_enlarged.svg)</a> | \[Mentioned in [issue&nbsp;7, &ldquo;Line colouration collisions&rdquo;](http://github.com/jdaw1/chart_markers/issues/7).\]<br/>From the [flag of Trinidad and Tobago](http://en.wikipedia.org/wiki/Flag_of_Trinidad_and_Tobago). | ![TTD](../ChartLines/TTD_line.svg)<br/>C8102E<br/>000000 |
...
| BSD | ![BSD](../ChartMarkers/BSD.svg) | <a name="BSD">![BSD](../ChartMarkers_enlarged/BSD_enlarged.svg)</a> | Triangle from the hoist of the [flag of the Bahamas](http://en.wikipedia.org/wiki/Flag_of_the_Bahamas), duplicated, back to back, in flag colours. | ![BSD](../ChartLines/BSD_line.svg)<br/>FFC72C<br/>00778B |
|  |  |  | <h2>[![ArrowDoubleU](ArrowDoubleU.svg)](#top)&nbsp;[![ArrowSingleU](ArrowSingleU.svg)](#americas)&nbsp;[![ArrowSingleD](ArrowSingleD.svg)](#development_banks)&nbsp;[![ArrowDoubleD](ArrowDoubleD.svg)](#end)&nbsp;&nbsp;<a name="euro_zone">Euro Zone</a></h2><p style="font-size: smaller;"><small>For official members ordered by capital key; then unofficial unilateral adopters ordered by GDP.</small></p> | |
| EU | ![EU](../ChartMarkers/EU.svg) | <a name="EU">![EU](../ChartMarkers_enlarged/EU_enlarged.svg)</a> | As for <span class="markerID">[EUR](#EUR)</span>&nbsp;=&nbsp;&euro;, except the horizontal line replaced by a star from the [flag of Europe](http://en.wikipedia.org/wiki/Flag_of_Europe), which is used as the flag of the European Union. | ![EU](../ChartLines/EU_line.svg)<br/>FF33FF<br/>FFFFFF |
...
| DE | ![DE](../ChartMarkers/DE.svg) | <a name="DE">![DE](../ChartMarkers_enlarged/DE_enlarged.svg)</a> | \[Mentioned in [issue&nbsp;7, &ldquo;Line colouration collisions&rdquo;](http://github.com/jdaw1/chart_markers/issues/7).\]<br/>Simplified from six to four columns, the [Brandenburg Gate](http://en.wikipedia.org/wiki/Brandenburg_Gate), in Berlin, Germany. | ![DE](../ChartLines/DE_line.svg)<br/>000000<br/>FFFFFF |
| FR | ![FR](../ChartMarkers/FR.svg) | <a name="FR">![FR](../ChartMarkers_enlarged/FR_enlarged.svg)</a> | [Hexagonal shape of France](http://en.wikipedia.org/wiki/Outline_of_France); in blue-white-red of [flag](http://en.wikipedia.org/wiki/Flag_of_France). | ![FR](../ChartLines/FR_line.svg)<br/>0055A4<br/>EF4135 |
| IT | ![IT](../ChartMarkers/IT.svg) | <a name="IT">![IT](../ChartMarkers_enlarged/IT_enlarged.svg)</a> | \[The subject of [issue&nbsp;3, &ldquo;Switch colours in IT&rdquo;](http://github.com/jdaw1/chart_markers/issues/3).\]<br/>Rome&rsquo;s [Colosseum](http://en.wikipedia.org/wiki/Colosseum), in the colours of the [flag of Italy](http://en.wikipedia.org/wiki/Flag_of_Italy). | ![IT](../ChartLines/IT_line.svg)<br/>008C45<br/>CD212A |
| ES | ![ES](../ChartMarkers/ES.svg) | <a name="ES">![ES](../ChartMarkers_enlarged/ES_enlarged.svg)</a> | From the [flag of Spain](http://en.wikipedia.org/wiki/Flag_of_Spain). | ![ES](../ChartLines/ES_line.svg)<br/>AD1519<br/>FABD00 |
| NL | ![NL](../ChartMarkers/NL.svg) | <a name="NL">![NL](../ChartMarkers_enlarged/NL_enlarged.svg)</a> | [Netherlands naval jack](http://en.wikipedia.org/wiki/Flag_of_the_Netherlands), in Dutch orange. | ![NL](../ChartLines/NL_line.svg)<br/>003DA5<br/>FA9B1E |
| BE | ![BE](../ChartMarkers/BE.svg) | <a name="BE">![BE](../ChartMarkers_enlarged/BE_enlarged.svg)</a> | From above, simplified, dome of [Palais de Justice](http://www.youtube.com/watch?v=YuFCixRYD7c) in Brussels, Belgium. | ![BE](../ChartLines/BE_line.svg)<br/>663319<br/>FFCC33 |
| AT | ![AT](../ChartMarkers/AT.svg) | <a name="AT">![AT](../ChartMarkers_enlarged/AT_enlarged.svg)</a> | From the [flag of Austria](http://en.wikipedia.org/wiki/Flag_of_Austria). | ![AT](../ChartLines/AT_line.svg)<br/>C8102E<br/>FFFFFF |
| GR | ![GR](../ChartMarkers/GR.svg) | <a name="GR">![GR](../ChartMarkers_enlarged/GR_enlarged.svg)</a> | From the [flag of Greece](http://en.wikipedia.org/wiki/Flag_of_Greece). | ![GR](../ChartLines/GR_line.svg)<br/>004C98<br/>FFFFFF |
| PT | ![PT](../ChartMarkers/PT.svg) | <a name="PT">![PT](../ChartMarkers_enlarged/PT_enlarged.svg)</a> | \[Mentioned in [issue&nbsp;7, &ldquo;Line colouration collisions&rdquo;](http://github.com/jdaw1/chart_markers/issues/7).\]<br/>[National Cockade of Portugal](http://en.wikipedia.org/wiki/National_symbols_of_Portugal#Vexillology), simplified. | ![PT](../ChartLines/PT_line.svg)<br/>DA291C<br/>046A38 |
| FI | ![FI](../ChartMarkers/FI.svg) | <a name="FI">![FI](../ChartMarkers_enlarged/FI_enlarged.svg)</a> | From the [flag of Finland](http://en.wikipedia.org/wiki/Flag_of_Finland). | ![FI](../ChartLines/FI_line.svg)<br/>002F6C |
| IE | ![IE](../ChartMarkers/IE.svg) | <a name="IE">![IE](../ChartMarkers_enlarged/IE_enlarged.svg)</a> | [Shamrock](http://en.wikipedia.org/wiki/Shamrock), in green and orange of [flag of Ireland](http://en.wikipedia.org/wiki/Flag_of_Ireland). | ![IE](../ChartLines/IE_line.svg)<br/>FF883E<br/>169B62 |
| SK | ![SK](../ChartMarkers/SK.svg) | <a name="SK">![SK](../ChartMarkers_enlarged/SK_enlarged.svg)</a> | \[Mentioned in [issue&nbsp;7, &ldquo;Line colouration collisions&rdquo;](http://github.com/jdaw1/chart_markers/issues/7).\]<br/>Cross from the [flag of Slovakia](http://en.wikipedia.org/wiki/Flag_of_Slovakia), symmetrified and simplified. | ![SK](../ChartLines/SK_line.svg)<br/>EF3340<br/>034DA3 |
| HR | ![HR](../ChartMarkers/HR.svg) | <a name="HR">![HR](../ChartMarkers_enlarged/HR_enlarged.svg)</a> | \[Mentioned in [issue&nbsp;7, &ldquo;Line colouration collisions&rdquo;](http://github.com/jdaw1/chart_markers/issues/7).\]<br/>From the coat of arms on the [flag of Croatia](http://en.wikipedia.org/wiki/Flag_of_Croatia), simplified. A similiar pattern appears on the kit of [Croatia&rsquo;s football team](http://en.wikipedia.org/wiki/Croatia_at_the_FIFA_World_Cup#/media/File:Croatia_WC2018_final.jpg). | ![HR](../ChartLines/HR_line.svg)<br/>FF0000<br/>000000 |
...
| SI | ![SI](../ChartMarkers/SI.svg) | <a name="SI">![SI](../ChartMarkers_enlarged/SI_enlarged.svg)</a> | \[Mentioned in [issue&nbsp;7, &ldquo;Line colouration collisions&rdquo;](http://github.com/jdaw1/chart_markers/issues/7).\]<br/>Star from Slovenia&rsquo;s [flag](http://en.wikipedia.org/wiki/Flag_of_Slovenia)&rsquo;s [coat of arms](http://en.wikipedia.org/wiki/Slovenia#/media/File:Coat_of_arms_of_Slovenia.svg). There does not seem to be an official specification of the inner radius of the star; the [wikimedia](http://upload.wikimedia.org/wikipedia/commons/8/8f/Coat_of_arms_of_Slovenia.svg) version uses an inner radius of &frac12;, also used here. | ![SI](../ChartLines/SI_line.svg)<br/>0060FF<br/>FFE600 |
| LV | ![LV](../ChartMarkers/LV.svg) | <a name="LV">![LV](../ChartMarkers_enlarged/LV_enlarged.svg)</a> | From [naval jack of Latvia](http://www.mil.lv/vienibas/juras-speki/juras-speku-stabs). | ![LV](../ChartLines/LV_line.svg)<br/>9D2235<br/>FFFFFF |
| LU | ![LU](../ChartMarkers/LU.svg) | <a name="LU">![LU](../ChartMarkers_enlarged/LU_enlarged.svg)</a> | \[Mentioned in [issue&nbsp;7, &ldquo;Line colouration collisions&rdquo;](http://github.com/jdaw1/chart_markers/issues/7).\]<br/>Based on the pediments of the ground floor of [Luxembourg City Hall](http://en.wikipedia.org/wiki/Luxembourg_City_Hall); in [flag](http://en.wikipedia.org/wiki/Flag_of_Luxembourg) colours. The [wikipedia picture](http://en.wikipedia.org/wiki/Luxembourg_City_Hall#/media/File:Luxemb_City_Hotel_de_ville_01.jpg) suggested an aspect ratio of 4&ratio;9, [trimmed](ChartMarkers_Description.md#aspect) to 1&ratio;2. | ![LU](../ChartLines/LU_line.svg)<br/>EF3340<br/>00A3E0 |
| EE | ![EE](../ChartMarkers/EE.svg) | <a name="EE">![EE](../ChartMarkers_enlarged/EE_enlarged.svg)</a> | Colours from the [flag of Estonia](http://en.wikipedia.org/wiki/Flag_of_Estonia); round for the towers in the [Walls of Tallinn](http://en.wikipedia.org/wiki/Walls_of_Tallinn). | ![EE](../ChartLines/EE_line.svg)<br/>0072CE<br/>000000 |
| CY | ![CY](../ChartMarkers/CY.svg) | <a name="CY">![CY](../ChartMarkers_enlarged/CY_enlarged.svg)</a> | Two symmetrified olive leaves from the [flag of Cyprus](http://en.wikipedia.org/wiki/Flag_of_Cyprus), in flag &lsquo;copper&rsquo; and green. | ![CY](../ChartLines/CY_line.svg)<br/>D57800<br/>4E5B31 |
| MT | ![MT](../ChartMarkers/MT.svg) | <a name="MT">![MT](../ChartMarkers_enlarged/MT_enlarged.svg)</a> | \[The subject of [issue&nbsp;6, &ldquo;Malta line colouring&rdquo;](http://github.com/jdaw1/chart_markers/issues/6).\]<br/>Cross of Malta, from its [&lsquo;Variant&rsquo; flag](http://en.wikipedia.org/wiki/Flag_of_Malta#/media/File:Civil_Ensign_of_Malta.svg). | ![MT](../ChartLines/MT_line.svg)<br/>CF142B<br/>C0C0C0 |
...
| ME | ![ME](../ChartMarkers/ME.svg) | <a name="ME">![ME](../ChartMarkers_enlarged/ME_enlarged.svg)</a> | *Globus crucifer azure crossed Or*, from the [coat of arms of Montenegro](http://en.wikipedia.org/wiki/Coat_of_arms_of_Montenegro#/media/File:Coat_of_arms_of_Montenegro.svg). | ![ME](../ChartLines/ME_line.svg)<br/>215F8F<br/>D3AE45 |
...
| \_CoEDB | ![\_CoEDB](../ChartMarkers/_CoEDB.svg) | <a name="_CoEDB">![_CoEDB](../ChartMarkers_enlarged/_CoEDB_enlarged.svg)</a> | From logo of the [Council of Europe Development Bank](http://coebank.org/en/). Bbg&nbsp;ticker&nbsp;=&nbsp;<kbd>COE&nbsp;Corp</kbd> | ![\_CoEDB](../ChartLines/_CoEDB_line.svg)<br/>092251<br/>FFFFFF |
...
| \_AfDB | ![\_AfDB](../ChartMarkers/_AfDB.svg) | <a name="_AfDB">![_AfDB](../ChartMarkers_enlarged/_AfDB_enlarged.svg)</a> | From [logo](http://www.afdb.org/sites/default/files/afdb_logo_en_1.jpg) of the [African Development Bank](http://www.afdb.org/). Bbg&nbsp;ticker&nbsp;=&nbsp;<kbd>AFDB&nbsp;Corp</kbd> | ![\_AfDB](../ChartLines/_AfDB_line.svg)<br/>000000<br/>039355 |
| \_AfExIm | ![\_AfExIm](../ChartMarkers/_AfExIm.svg) | <a name="_AfExIm">![_AfExIm](../ChartMarkers_enlarged/_AfExIm_enlarged.svg)</a> | From [logo](http://www.afreximbank.com/wp-content/themes/afrexim/assets/favicons/coast-228x228.png) of [Afreximbank](http://www.afreximbank.com/) = Africa Export-Import Bank. Bbg&nbsp;ticker&nbsp;=&nbsp;<kbd>AFEXI&nbsp;Corp</kbd> | ![\_AfExIm](../ChartLines/_AfExIm_line.svg)<br/>198D66<br/>FCB90E |
| \_IADB | ![\_IADB](../ChartMarkers/_IADB.svg) | <a name="_IADB">![_IADB](../ChartMarkers_enlarged/_IADB_enlarged.svg)</a> | \[Mentioned in [issue&nbsp;9, &ldquo;IADB improvement&rdquo;](http://github.com/jdaw1/chart_markers/issues/9).\]<br/>Rearranged [logo](http://pbs.twimg.com/profile_images/1226897864263118848/a6Q8-_nS_200x200.png) of the [Inter-American Development Bank](http://www.iadb.org/en). Bbg&nbsp;ticker&nbsp;=&nbsp;<kbd>IADB&nbsp;Corp</kbd> | ![\_IADB](../ChartLines/_IADB_line.svg)<br/>005073<br/>FFFFFF |
| \_BCIE | ![\_BCIE](../ChartMarkers/_BCIE.svg) | <a name="_BCIE">![_BCIE](../ChartMarkers_enlarged/_BCIE_enlarged.svg)</a> | From [logo](http://bcie.org/typo3conf/ext/bcie_package/Resources/Public/Images/logo-bcie-2021.png) of [Banco Centroamericano de Integraci&oacute;n Econ&oacute;mica](http://bcie.org/) = Central American Bank for Economic Integration. Bbg&nbsp;ticker&nbsp;=&nbsp;<kbd>CABEI&nbsp;Corp</kbd> | ![\_BCIE](../ChartLines/_BCIE_line.svg)<br/>2BCE75<br/>0046C2 |
| \_CDB | ![\_CDB](../ChartMarkers/_CDB.svg) | <a name="_CDB">![_CDB](../ChartMarkers_enlarged/_CDB_enlarged.svg)</a> | From [logo](http://www.caribank.org/themes/custom/cdb/logo.svg) of the [Caribbean Development Bank](http://www.caribank.org/). Bbg&nbsp;ticker&nbsp;=&nbsp;<kbd>CARDEV&nbsp;Corp</kbd> | ![\_CDB](../ChartLines/_CDB_line.svg)<br/>EFBE20<br/>0B5CAE |
